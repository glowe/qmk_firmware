...
/*
 * The Ordinary Colemak Layout for the Ergodox EZ keyboard, v0.1
 *
 * Modifications from ordinary layout by Graham Lowe
 *
 ...
 * |------------+------+------+------+------+-------------|       |------+------+------+------+------+------+------------|
 * | Media  Tab |   Q  |   W  |   F  |   P  |   G  |  [   |       |   ]  |   J  |   L  |   U  |   Y  |   P  | \|   Media |
 * |------------+------+------+------+------+------|      |       |      |------+------+------+------+------+------------|
 * | Symbol     |   A  |   R  |   S  |   T  |   D  |------|       |------|   H  |   N  |   E  |   I  |  ;   | '"  Symbol |
 * |------------+------+------+------+------+------|LCtrl |       |Rctrl |------+------+------+------+------+------------|
 * | Capitals   |   Z  |   X  |   C  |   V  |   B  |      |       |      |   K  |   M  |   ,  |   .  |  /   |   Capitals |
 * `------------+------+------+------+------+-------------'       `-------------+------+------+------+------+------------'
...
,F(LMdia)  ,KC_Q   ,KC_W   ,KC_F   ,KC_P  ,KC_G  ,KC_LBRC
,M(LSymb)  ,KC_A   ,KC_R   ,KC_S   ,KC_T  ,KC_D
...
,KC_LCTL   ,KC_MEH ,KC_HYPR,KC_LALT,KC_LGUI
                                 ...
                                 ,KC_BSPC,KC_DEL ,KC_PGDN
                                                                 ...
                                                                 ,KC_RBRC ,KC_J   ,KC_L   ,KC_U   ,KC_Y    ,KC_SCLN  ,F(RMdia)
                                                                          ,KC_H   ,KC_N   ,KC_E   ,KC_I    ,KC_O     ,F(RSymb)
                                                                 ,KC_RCTL  ,KC_K   ,KC_M   ,KC_COMM,KC_DOT  ,KC_SLSH  ,KC_RSFT
